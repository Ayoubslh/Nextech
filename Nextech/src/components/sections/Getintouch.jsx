        ...
        <section className="py-16 bg-gray-200">
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-2xl text-gray-600 max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card2 className="p-6">
                            ...
                            <button className="w-full bg-red-500 text-white px-6 py-3 rounded-lg hover:bg-red-600 transition-colors duration-200 font-medium">
                        ...
                        <Card2 className="p-6">
                            ...
                            <button className="w-full bg-gray-400 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-500 hover:text-white transition-colors duration-200 font-medium">
                                Download App
                            </button>
                        </Card2>
                    </div>
