        ...
        <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-gray-200">
            <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-7xl">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                    ...
                    <Card2 className="order-2 xl:order-1">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                            <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 mr-0 sm:mr-3 mb-2 sm:mb-0">
                        ...
                        <form className="space-y-3 sm:space-y-4">
                            ...
                            <button 
                                className="w-full bg-red-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-md sm:rounded-lg hover:bg-red-600 active:bg-red-700 transition-colors duration-200 flex items-center justify-center font-medium text-sm sm:text-base" 
                                type="submit"
                            >
                    ...
                    <div className="space-y-3 sm:space-y-4 md:space-y-6 order-1 xl:order-2">
                        {/* Email Us Card */}
                        <Card2>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center mb-3 sm:mb-4 md:mb-6">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 mr-0 sm:mr-3 mb-2 sm:mb-0">
